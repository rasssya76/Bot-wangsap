...
`;
        sendButImage(from, menu, "by @RamaGans ❤️", thumb, [
          {
      ...
      case "owner":
        ...
        sendButMessage(
          ...
          [
            ...
            {
              buttonId: `${prefix}igstalk RamaGans`,
              buttonText: {
...
case "suit":
  if (isBanned) return reply(mess.ban)
  sendButMessage(from, `Pilih Gunting Kertas Atau Batu`, `case By @RamaGans`, [
          {
...
Silahkan pilih, apakah kamu mau aku kirim virtex?`, `Virtex By @RamaGans`, [
          {
...
break
                    ...
                    syaa.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig @RamaGans', quoted: mek})
                break
case "attp":
  if (isBanned) return reply(mess.ban)
...
case 'donat':
  ...
  ├─ ❏ 081515589573
  ├─ ❏ *INSTAGRAM*
  └─ ❏ https://www.instagram.com/@RamaGans`)
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 62815155895738|Arasya
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
...
if (!tex2) return reply('Format salah!')
          ...
          res = await upload(owgi);
                    teks = `${res.result.images}`
										buffer = `https://hardianto-chan.herokuapp.com/api/creator/memegen?bawah=${tex2}&atas=${tex1}&imgurl=${res}&apikey=hardianto`
										sendStickerFromUrl(from, images, buffer)
									 }
									break
case 'memegenerator':
    case 'memegen':
...
case 'stcmeme':
   ...
   var njay = await imgbb('520bd6f6209077d1777c2a4f20c509c2', media)
   var resu = await getBuffer(`https://api.memegen.link/images/custom/${teks1}/${teks2}.png?background=${njay.display_url}`)
   sendStickerFromUrl(from, resu, sticker, {quoted: mek})
    fs.unlinkSync(media)
    } catch (e) {
    return reply(`${e}`)
    console.log(e)
...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "grup":
        ...
        sendButMessage(from, `Mau tanya² tentang arasya?`, `FOLLOW ANJING INSTAGRAM GW @RamaGans GC ANJING`, [
          {
        ...
        break;
        case "scjojobot":
        reply(`https://youtu.be/OpVvYMn14ik
        
        Sc nya ada didalam video itu`)
        break
...
////////////
case "sofunsyabi":
              reply(`*ID* : 39699343414

*Username* : sofunsyabi
*Full Name* : Arasya Rafi
*Bio* : 🇮🇩
"Whoever is serious, will surely succeed"
مَنْ جَدَّ وَجَدَ
*Followers* : 4316
*Following* : 516
*Private* : false
...
*Link* : https://instagram.com/sofunsyabi`)
              break
case "stats":
              reply(`Statusnya Kak Arasya Jomblo:v,ada yg mau sama arasya?:v`)
              break
case "wa":
              reply(`pencet link di bawah\n\nwa.me/6281515589573?text=Hai+Sayang`)
              break
case "email":
              reply(`arasyarafi02@gmail.com`)
              break
      //------------------< Fitur downloader >-------------------
      case 'tiktoknowm':
				reply('loading...')
...
case 'tiktokvid':
    ...
    Follower: ${i.result.stats.followerCount}`;
     ...
     /* case "waifu":
      ...
      case "aeshtetic":
      case "wallpaperanime":
        sendButMessage(from, `Random Image by @RamaGans`, `press the button below`, [
          {
